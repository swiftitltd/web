...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Dashboard -->
        <li class="nav-item">
            <a class="nav-link" href="donor-home.html">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">Confirm Donation</h1><hr>
                <div class="row">
                    <div class="col-lg-4">
                        <!-- Basic Card Example -->
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Confirm Your donation with following information</h6>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('donation-submit') }}" method="post">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="items" class="form-control" value="{{ $items }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control" name="quantity" placeholder="Quantity/Amount *"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <textarea class="form-control" name="note" placeholder="Note (if any)"></textarea>
                                    </div>


                                    <button type="submit" class="btn btn-lg btn-primary">Confirm Donation</button>
                                </form>
                            </div>
                        </div>
